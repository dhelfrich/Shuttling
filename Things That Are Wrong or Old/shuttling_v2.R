...
eps <- .00006 # emissivity of the radiative surface
...
T_btrack[1] <- T_b0
time_track <- seq(0,100,length=1000)
for (i in (1:length(time_track))){
...
windows()
plot(time_track,T_btrack[1:1000],main='Plot of Body Temp over Time',xlab='Time Steps',
