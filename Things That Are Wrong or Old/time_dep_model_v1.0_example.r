...
fTb_t <- function(newTa,oldTa,Tb_0){
  ...
  Qa <- 3750 # absorbed incoming radiation (W m^-2)
  ...
  Mp <- 1.917666667e-5 # Metabolic rate at preferred temp (J/s)
  ...
  P <- .97975 # slope of relationship between Net_M and Tb (J/s/degC)
